...
proc create_ipi_design { offsetfile design_name } {
	...
	set SNN_PROCESSOR_0 [ create_bd_cell -type ip -vlnv user.org:user:SNN_PROCESSOR:1.0 SNN_PROCESSOR_0 ]
	...
	# Connect all clock & reset of SNN_PROCESSOR_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins SNN_PROCESSOR_0/CONTROLS]
	connect_bd_net [get_bd_pins SNN_PROCESSOR_0/controls_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins SNN_PROCESSOR_0/controls_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins SNN_PROCESSOR_0/SYNAPSES]
	connect_bd_net [get_bd_pins SNN_PROCESSOR_0/synapses_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins SNN_PROCESSOR_0/synapses_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M02_AXI] [get_bd_intf_pins SNN_PROCESSOR_0/PARAMSPACE]
	connect_bd_net [get_bd_pins SNN_PROCESSOR_0/paramspace_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins SNN_PROCESSOR_0/paramspace_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock & reset of SNN_PROCESSOR_0 streaming interfaces..
	connect_bd_net [get_bd_pins SNN_PROCESSOR_0/spike_in_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins SNN_PROCESSOR_0/spike_in_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins SNN_PROCESSOR_0/spike_out_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins SNN_PROCESSOR_0/spike_out_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to SNN_PROCESSOR_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/SNN_PROCESSOR_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_SNN_PROCESSOR_0_CONTROLS_* ]]
	puts $fp "set controls_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_SNN_PROCESSOR_0_PARAMSPACE_* ]]
	puts $fp "set paramspace_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_SNN_PROCESSOR_0_SYNAPSES_* ]]
	puts $fp "set synapses_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:SNN_PROCESSOR:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/SNN_PROCESSOR_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "SNN_PROCESSOR_hw_${i}"
